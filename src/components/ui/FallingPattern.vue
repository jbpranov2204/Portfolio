<template>
  <div :class="['relative h-full w-full p-1', className]">
    <div
      class="relative h-full w-full z-0 falling-pattern"
      :style="patternStyle"
    ></div>
    <div
...
const patternStyle = computed(() => ({
  ...
  backgroundImage: generateBackgroundImage(props.color),
  backgroundSize: backgroundSizes,
  backgroundPosition: startPositions,
  backgroundRepeat: 'repeat',
  '--start-pos': startPositions,
  '--end-pos': endPositions,
  animationDuration: `${props.duration}s`,
}))

const overlayStyle = computed(() => ({
  backdropFilter: `blur(${props.blurIntensity})`,
  WebkitBackdropFilter: `blur(${props.blurIntensity})`,
