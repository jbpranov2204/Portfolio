<template>
  <footer class="relative border-t border-white/10 bg-dark-800/50 backdrop-blur-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <!-- Footer Content -->
      <div class="grid md:grid-cols-4 gap-8 mb-12">
        <!-- Brand -->
        <div>
          <h3 class="text-2xl font-bold gradient-text mb-4">Pranov JB</h3>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <a href="#home" class="text-gray-400 hover:text-cyan-400 transition-colors">Home</a>
            </li>
            <li>
              <a href="#about" class="text-gray-400 hover:text-cyan-400 transition-colors">About</a>
            </li>
            <li>
              <a href="#projects" class="text-gray-400 hover:text-cyan-400 transition-colors">Projects</a>
            </li>
            <li>
              <a href="#contact" class="text-gray-400 hover:text-cyan-400 transition-colors">Contact</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <span class="text-gray-400">AI/ML Development</span>
            </li>
            <li>
              <span class="text-gray-400">Full Stack Development</span>
            </li>
            <li>
              <span class="text-gray-400">Consulting</span>
            </li>
            <li>
              <span class="text-gray-400">Custom Solutions</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="flex gap-4">
            <a
              ...
              class="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/15 hover:border-cyan-500/30 transition-all duration-300 group"
              :title="social.name"
            >
    ...
    <div class="absolute top-0 right-0 -z-10 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"></div>
  </footer>
</template>
